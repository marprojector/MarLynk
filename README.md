# [MarLynk](https://marlynk.vercel.app/)

[![Skateshop](./public/images/screenshot.png)](https://marlynk.vercel.app/)

MarLynk is a free open source tool to generate short links
. With a user-friendly interface and robust functionality, MarLynk makes it easy to share and manage shortened links.
...
1. Clone the repository
   ...
   ```bash
   git clone https://github.com/marprojector/MarLynk
   ```
